...
hi! TabLine      cterm=NONE      ctermbg=245 ctermfg=234   gui=NONE guibg=#003C4B guifg=#003C4B
hi! TabLineFill  cterm=reverse   ctermbg=234 ctermfg=245   gui=NONE guibg=#003C4B guifg=#003C4B
hi! TabLineSel   cterm=NONE      ctermbg=234 ctermfg=252   gui=NONE guibg=#003C4B guifg=#003C4B
